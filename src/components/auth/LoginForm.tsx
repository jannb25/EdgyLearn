...
export const LoginForm = ({ onLogin, onForgotPassword, onRegister }: LoginFormProps) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-learning-blue-light to-trust-blue-light flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/80">Plataforma de Aprendizaje Adaptativo</p>
        </div>
        ...
        <Card className="shadow-learning bg-card/95 backdrop-blur-sm border-0">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" variant="learning" className="w-full">
                Iniciar Sesión
              </Button>
