		...
		extend: {
			colors: {
				...
				'success-green': {
					...
					dark: 'hsl(var(--success-green-dark))'
				},
				'growth-green': {
				...
				'progress-amber': {
					DEFAULT: 'hsl(var(--progress-amber))',
					light: 'hsl(var(--progress-amber-light))'
				},
				sidebar: {
			...
			backgroundImage: {
				...
				'gradient-hero-admin': 'var(--gradient-hero-admin)',
